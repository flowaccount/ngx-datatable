  ...
  groupedRows = [
    ...
    },
    {
      ...
      value: [
        ...
        { name: 'Sarah Massey', gender: 'female', company: 'Bisba', age: 10 }
      ]
    },
    {
      key: 11,
      value: [
        { name: 'Robles Boyle', gender: 'male', company: 'Comtract', age: 11 },
        { name: 'Evans Hickman', gender: 'male', company: 'Parleynet', age: 11 }
      ]
    },
    {
      key: 50,
      value: [
        { name: 'Robles Boyle', gender: 'male', company: 'Comtract', age: 50 },
        { name: 'Evans Hickman', gender: 'male', company: 'Parleynet', age: 50 }
      ]
    },
    {
      key: 51,
      value: [
        { name: 'Robles Boyle', gender: 'male', company: 'Comtract', age: 51 },
        { name: 'Evans Hickman', gender: 'male', company: 'Parleynet', age: 51 }
      ]
    },
    {
      key: 52,
    ...
    },
    {
      ...
      value: [
        ...
        { name: 'Bruce Strong', gender: 'male', company: 'Xyqag', age: 12 }
      ]
    },
    {
      key: 53,
    ...
    },
    {
      key: 54,
      value: [
        { name: 'Robles Boyle', gender: 'male', company: 'Comtract', age: 54 },
        { name: 'Evans Hickman', gender: 'male', company: 'Parleynet', age: 54 }
      ]
    },
    {
      key: 56,
      value: [
        { name: 'Robles Boyle', gender: 'male', company: 'Comtract', age: 56 },
        { name: 'Evans Hickman', gender: 'male', company: 'Parleynet', age: 56 }
      ]
    },
    {
      key: null,
      value: [
        { name: 'No Group1', gender: 'male', company: 'Xyqag', age: null },
        { name: 'No Group2', gender: 'male', company: 'Xyqag', age: null },
        { name: 'No Group3', gender: 'male', company: 'Xyqag', age: null },
        { name: 'No Group4', gender: 'male', company: 'Xyqag', age: null }
      ]
    }
  ];
  constructor() {
